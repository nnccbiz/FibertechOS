...
9. כשמשתמש מעלה קובץ תמחור (הצעת מחיר מספק, מחירון, טבלת עלויות) — חלץ את כל הפריטים והחזר:
   ...
   - action: "import"
   - currency: זהה את המטבע מהמסמך (USD, EUR, ILS, GBP וכו'). אל תניח שזה שקלים — בדוק סימנים ($, €, ₪, £), כיתוב (דולר, יורו, שקל) או כל רמז אחר במסמך.
   ...
   - חלץ את כל השורות מהטבלה/מסמך, כולל קוטר, כמות, מחיר — שמור על המחירים המקוריים כפי שמופיעים במסמך
   - אם יש קוטר DN — שים אותו ב-dn_size
   - summary: "חולצו X פריטים מהקובץ (מטבע: USD/EUR/ILS)"
1. החזר רק JSON תקין
